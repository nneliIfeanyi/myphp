...
if(!isset($_SESSION['username'])){
  ...
  if (isset($_GET['class']) && isset($_GET['subject']) && isset($_GET['sub_date'])) {
  	$class = $_GET['class'];
  	...
  	header("location:set_homework.php");
  }
			...
			<div class="w3-twothird w3-margin-bottom">
				<div class="w3-light-grey w3-round">
						...
						<h3 class="w3-padding-16 w3-blue w3-center"><b>PREVIEW ASSIGNMENT</b></h3>
						  ...
						  <div class="w3-margin w3-padding-16"><a href="set_homework.php" class="w3-btn w3-padding w3-blue" >Return</a></div>
