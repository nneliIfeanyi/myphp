                 ...
                 <section class="col-lg-12 connectedSortable">
                     <div class="card">
                         ...
                         <div class="card-header">
                             <h3 class="card-title">
                                 <a href="<?php echo $conn->base_url(); ?>add-comment"><i class="fa fa-plus"></i>Add a comment
                                 </a>
                             </h3>
                         </div>
                         <div class="card-body">
                             ...
                             <div>
                                 <?php
                                  ...
                                  foreach ($result as $class){
                                      ...
                                      $link = $base_url."report-comments/$slugify_class_name";
...
<!--          Delete teacher modal end -->
    ...
    if(isset($_POST['delete_comment'])){
        ...
        $conn->query($sql);
        $conn->bind(":id", $id);
        $redirect = $base_url.'report-comments';
