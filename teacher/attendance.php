                 ...
                 <section class="col-lg-12 connectedSortable">
                     <div class="card">
                         ...
                         <div class="card-header">
                             <h3 class="card-title">
                                 <a href="<?php echo $teacher_url; ?>/add-attendance"><i class="fa fa-plus"></i>Add attendance
                                 </a>
                             </h3>
                         </div>
                         <div class="card-body">
                             ...
                             <div>
                                ...
                                $result = $conn->fetchMultiple();
                                  ...
                                  foreach ($result as $class){
                                      ...
                                      $link = $teacher_url."/attendance/$slugify_class_name";
...
<!--          Delete teacher modal end -->
    ...
    if(isset($_POST['delete_attendance'])){
        ...
        $conn->query($sql);
        $conn->bind(":id", $id);
        $redirect = $teacher_url.'/attendance';
