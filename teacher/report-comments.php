...
<head>
    ...
    <title> Report Card Comments | <?php echo $school_name; ?></title>
    <style>
            .card-title a {
            font-size: 16px;
                 ...
                 <section class="col-lg-12 connectedSortable">
                     <div class="card">
                         ...
                         <div class="card-header">
                             <h3 class="card-title">
                                 <a href="<?php echo $teacher_url; ?>/add-comment"><i class="fa fa-plus"></i>Add a comment
                                 </a>
                             </h3>
                         </div>
                         <div class="card-body">
                             <h3 class="card-title text-center" style="font-size: 15px;">
                                 Please select a class to view the students' comments
                                 <i class="fa fa-info-circle" data-toggle="tooltip" title="N:B: Only classes with comments added are clickable."></i>
                             ...
                             <div>
                                 <?php
                                  ...
                                  foreach ($result as $class){
                                      ...
                                      $sql = "SELECT COUNT(id) FROM comments WHERE class =:class_id AND class_teacher_comment !='' AND principal_comment != ''";
                                      $conn->query($sql);
                                      $conn->bind(":class_id", $class_name);
                                      $comments_available = $conn->fetchColumn();
                                      //enable or disable link on number of available sections
                                      $slugify_class_name = $conn->slugify($class_name);
                                      $link = $teacher_url."/report-comments/$slugify_class_name";
                                      ...
                                      ?>> <span class="badge <?php echo $badge_color[$n];?>" data-toggle="tooltip"
                                                title="<?php echo $comments_available; ?> comment(s) available in class <?php echo $class_name; ?>">
                                             <?php echo $comments_available; ?>
                                          </span>
                             ...
                             <?php
                              if(isset($_GET['class_name'])){
                                  ...
                                  $sql = "SELECT *  FROM comments WHERE class =:class_name AND class_teacher_comment !='' AND principal_comment != ''";
                                  $conn->query($sql);
                                  ...
                                  <div class="card-header" style="background: #c3570f; color: #fff; margin: 20px 0 2px;">
                                      <h3 class="card-title" style="font-size: 15px;">
                                          <i class="fa fa-star"></i>
                                          Viewing Comments details for class <?php echo $new_class_name; ?>
                                      </h3>
                                  </div>
                                  ...
                                  <table id="teacher" class="table table-bordered table-striped">
                                      ...
                                      if($conn->rowCount() > 0){
                                          foreach ($result_details as $student_details):
                                              ...
                                              $comment_id = $student_details->id;
                                              $section = $student_details->section;
                                              $exam = $student_details->exam;
                                              $exam_year = $student_details->exam_year;
                                              $teacher_comment = $student_details->class_teacher_comment;
                                              $principal_comment = $student_details->principal_comment;
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php echo $teacher_comment;?></td>
                                                  <td><?php echo $principal_comment;?></td>

                                                  <td>
                                                      <a href="javascript:void();" data-toggle="modal" data-target="#delete-comment<?php echo $comment_id; ?>">
                                                          <i class="fa fa-trash" data-toggle="tooltip" title="Delete comment"></i>
                                                      </a>&nbsp;
                                          ...
                                          ?>
                                          <tr>
                                              <td colspan="10" class="text-center">No Data in table</td>
                                          </tr>
                                          <?php
                                      }
                                      ?>
...
<!--          Delete subject modal start-->
          <div class="modal fade" id="delete-comment<?php echo $comment_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-md" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Delete comment for <?php echo $name; ?></h5>
                      ...
                      <div class="modal-body">
                          ...
                          <div class="modal-footer" style="margin-bottom: -10px;">
                              ...
                              <input type="submit" class="btn btn-outline-danger" value="Delete Comment" id="submit" name="delete_comment">
                          </div>
                          </form>
                      </div>
                  </div>
...
<!--          Delete teacher modal end -->
    ...
    if(isset($_POST['delete_comment'])){
        ...
        $conn->query($sql);
        $conn->bind(":id", $id);
        $redirect = $teacher_url.'/report-comments';
