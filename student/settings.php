...
<head>
    ...
    <title> Change Account Password | <?php echo $school_name; ?></title>
    <style>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Change Account Password </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-lg-8">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Enter old and new password below</h3>
                            </div>
                            ...
                            <form action="" class="form-horizontal" method="post" id="change-password">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="hidden" name="username" value="<?php echo $_SESSION['student'];?>">
                                    </div>
...
<script>
    ...
    $('#change-password').on('submit', function(event){
        ...
        if($('#change-password').parsley().isValid()){
            $.ajax({
                url: "<?php echo $conn->student_url(); ?>update-settings.php",
                method: "POST",
                ...
                beforeSend: function () {
                    ...
                    $('#submit').val('Updating password details, pls wait ......');
