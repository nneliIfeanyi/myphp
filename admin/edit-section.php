...
<head>
    ...
    <title> Edit Section | <?php echo $school_name; ?></title>
    <style>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Editing Section <?php echo $section_name; ?></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?php echo $conn->base_url(); ?>section">All sections</a></li>
                            <li class="breadcrumb-item active"><?php echo $section_name; ?></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card card-info">
                            ...
                            <form action="" class="form-horizontal" method="post" id="section-edit">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-3 col-form-label">Section name <span
                                                    style="color: #f00;">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="name" required
                                                   data-parsley-trigger="keyup" name="name" value="<?php echo $section_name; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="category" name="category" class="form-control"
                                                   required data-parsley-trigger="keyup" value="<?php echo $category; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="capacity" class="col-sm-3 col-form-label">Capacity<span
                                                    style="color: #f00;">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="number" id="capacity" name="capacity" class="form-control"
                                                   required data-parsley-trigger="keyup" value="<?php echo $capacity; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="class" id="class" class="form-control select2" required
                                                    data-parsley-trigger="keyup" style="width: 100%;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="submit" name="edit_section" value="Update Section"
...
<script>
    $('#section-edit').parsley();
    $('#section-edit').on('submit', function(event){
        event.preventDefault();
        if($('#section-edit').parsley().isValid()){
            $.ajax({
                url: "<?php echo $base_url; ?>process-edit-section.php",
                method: "POST",
                ...
                beforeSend: function () {
                    ...
                    $('#submit').val('Updating section details, pls wait ......');

                },
                success:function (data) {
                    $('#section-edit').parsley().reset();
                    $('#submit').attr('disabled', false);
                    $('#submit').val('Update Section');
