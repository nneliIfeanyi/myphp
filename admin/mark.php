                 ...
                 <section class="col-lg-12 connectedSortable">
                     <div class="card">
                         ...
                         <div class="card-header">
                             <h3 class="card-title">
                                 <a href="<?php echo $conn->base_url(); ?>add-mark">Add a mark
                         ...
                         <div class="card-body">
                             <h3 class="card-title text-center" style="font-size: 15px;">
                                 Please select a class to view the students' marks
                             ...
                             <?php
                              if(isset($_GET['class'])){
                                  ...
                                  <div class="card-header" style="background: #c3570f; color: #fff; margin: 20px 0 2px;">
                                      <h3 class="card-title" style="font-size: 15px;">
                                          <i class="fa fa-star"></i>
                                          Viewing Students details for class <?php echo $class_name; ?> <span style='color: black; font-size: 16px;'>(Click on view to view student makr details)</span>
                                      </h3>
                                  </div>
                                      ...
                                      if($conn->rowCount() > 0){
                                          foreach ($result as $student_details):
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      <a href="<?php echo $base_url; ?>view-student/<?php echo $username;?>" data-toggle="tooltip" title="View Terminal Reports">
