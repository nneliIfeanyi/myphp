        ...
        if ($rowCount > 0) {
            ...
            foreach ($result as $student) {
                ...
                $output .= "<tr>
                     ...
                     <input type='hidden' name='first_ca_score[]' placeholder='1st CA' class='form-control' max='20' min='0' value='$existing_first_ca_scores'>
                     <input type='hidden' name='second_ca_score[]' placeholder='2nd CA' class='form-control' max='20' min='0' value='$existing_second_ca_scores'>
                     <td><input type='number' name='exam_score[]' placeholder='Exam score' class='form-control' max='20' min='0' value='$existing_exam_scores'></td>
