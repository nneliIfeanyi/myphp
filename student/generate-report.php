        ...
        if ($rowcount > 0) {
            ...
            class PDF extends TCPDF
            {
                ...
                public function Header()
                {
                    ...
                    $imageFile = $admin_url . "upload/$school_logo";
                    $this->Image($imageFile, 20, 2, 20, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
                    $this->Ln(2);
                    $this->SetTextColor(185, 2, 0);
                    $this->SetFont('helvetica', 'B', 20);
                    $this->cell(175, 2, "$school_name", 0, 1, "C");
                    $this->SetTextColor(14, 93, 117);
                    $this->SetFont('helvetica', 'B', 10);
                    $this->cell(175, 3, "$school_tagline", 0, 1, "C");


                    if (!empty($school_website)) {
                        $this->SetTextColor(0, 0, 0);
                        $this->SetFont('helvetica', 'B', 10);
                        $this->cell(175, 2, "Website: $school_website", 0, 1, "C");
                        $this->SetTextColor(0, 0, 0);
                        $this->SetFont('helvetica', '');
                        $this->cell(86, 0, '_________________________________________________________________________________', 0, '', '', '');
                    }
                    $this->Ln();
                    $this->SetTextColor(0, 0, 0);
                    $this->SetFont('helvetica', '');
            ...
            ";
                ...
                public function Footer()
                {
                    ...
                    $this->MultiCell(159, 5, "Entrance Examination Result Slip", 0, 'C', 0, 1, '', '', true);
                }
            }


            // create new PDF document
            $pdf = new PDF('P', PDF_UNIT, array(190, 190), true, 'UTF-8', false);

            // set document information
            global $school_name;
            $pdf->SetCreator(PDF_CREATOR);
            $pdf->SetAuthor("$school_name");
            $pdf->SetTitle('Entrance Examination Result Slip');
            ...
            $pdf->Cell(60, 4, 'Subject', 1, 0, 'L', 1);
            $pdf->Cell(35, 4, 'Score(20)', 1, 0, 'C', 1);
            $pdf->Cell(27, 4, 'Grade', 1, 0, 'C', 1);
            $pdf->Cell(37, 4, 'Remark', 1, 0, 'C', 1);
            $total_score = 0;
            foreach ($result as $report_details) {
                ...
                $pdf->Cell(60, 3, $subject_offered, 0, 0, "L");
                $pdf->Cell(35, 3, $exam_score, 0, 0, "C");
                // $pdf->Cell(40, 3, $grade, 0, 0, "L");
                // $pdf->Cell(40, 3, $remark, 0, 0, "L");
            }
            $pdf->Ln(4);
            $pdf->MultiCell(189, 7, '___________________________________________________________________', 0, 'L', 0, 1, '', '', true);
            $pdf->SetTextColor(14, 93, 117);
            $pdf->SetFont('times', 'B', '11');
            $pdf->Cell(60, 4, 'Total', 0, 0, "L");
            $pdf->Cell(35, 4, $total_exam_score, 0, 0, "C");
            $pdf->Cell(27, 3, $grade, 0, 0, "C");
            $pdf->Cell(37, 3, $remark, 0, 0, "C");
            $total_marks_obtained = $total_exam_score;
            global $total_marks_obtained;
            $pdf->Ln(8);
            $mark_average = $total_score;
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetFont('times', 'B', '11');
            $pdf->Cell(21, 4, "Percentage: ", 0, 0, "L");
            $pdf->SetFont('times', 'N', '11');
            $pdf->Cell(20, 4, "$mark_average %", 0, 0, "L");
            ...
            if ($mark_average >= $pass_percent) {
                ...
                $pdf->Cell(26, 5, "Passed", 0, 0, "L");
            } else {
                $pdf->SetTextColor(255, 0, 0);
                $pdf->SetFont('times', 'B', '10');
                $pdf->Cell(26, 5, "Failed", 0, 0, "L");
            }
...
?>
            ...
            <meta http-equiv="refresh" content="3; <?php echo $back_to_terminal_report; ?>">
        <?php
    ...
    // Entrance Exam Ends
            ...
            class PDF extends TCPDF
        {
            ...
            public function Header()
            {
                ...
                global $year;
                $this->student_name = $name;
                $sql = $sql = "SELECT * FROM results WHERE name_of_student =:name AND class =:class 
                                AND exam=:exam AND section =:section AND school_year =:year";
                $conn->query($sql);
                $conn->bind(":name", $this->student_name);
                $conn->bind(":class", $class);
            ...
            ";
              ...
              <div class='row'>
                 ...
                 <p></p>
                  ...
                  <p><strong>Section:</strong> $new_section</p>
            ...
            public function Footer()
            {
                ...
                $this->Ln(8);
                $this->SetFont('times', 'B', '10');
                $this->MultiCell(189, 5, 'TERMINAL REPORT', 0, 'C', 0, 1, '', '', true);
...
//        $pdf->Ln(10);
        ...
        ?>
            ...
            <meta http-equiv="refresh" content="17; <?php echo $redirect; ?>">
