...
<head>
    ...
    <title> Add Exam | <?php echo $school_name; ?></title>
    <style>
                 ...
                 <div class="col-lg-8">
                     <div class="card card-info">
                         <div class="card-header">
                             <h3 class="card-title">Enter exam details below</h3>
                         </div>

                         <form action="" class="form-horizontal" method="post" id="exam-add">
                              <div class="card-body">
                             <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="submit" name="add_exam" value="Add Exam" class="btn btn-info" id="submit">
                                    </div>
                                </div>
...
<script>
    $('#exam-add').parsley();
    $('#exam-add').on('submit', function(event){
        event.preventDefault();
        if($('#exam-add').parsley().isValid()){
            $.ajax({
                url: "<?php echo $base_url; ?>process-add-exam.php",
                method: "POST",
                ...
                beforeSend: function () {
                    ...
                    $('#submit').val('Adding exam details, pls wait ......');

                },
                success:function (data) {
                    $('#exam-add').parsley().reset();
