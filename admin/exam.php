...
if(isset($_SESSION['username'])){
    ...
    <head>
        ...
        <title> Exam | <?php echo $school_name; ?></title>
        <style>
            ...
            <div class="container-fluid">
                <div class="row">
                    <section class="col-lg-12 connectedSortable">
                        <a href="<?php echo $conn->base_url(); ?>add-exam"> <button class="btn btn-outline-success">Add an exam </button></a>
                    </section>
                                    ...
                                    if($rowCount > 0){
                                        foreach ($result as $exam):
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo $base_url;?>edit-exam/<?php echo $exam_id;?>" data-toggle="tooltip" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                    </a>&nbsp;
                                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#delete-exam<?php echo $exam_id;?>">
